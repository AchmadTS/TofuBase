...
public class ModalTambahPengeluaran extends JDialog {
    ...
    public ModalTambahPengeluaran(Frame parent, PengeluaranPanel parentPanel) {
        super(parent, "Tambah Pengeluaran", true);
        this.parentPanel = parentPanel;
        this.pengeluaranDAO = new PengeluaranDAO();
    ...
    private void initComponents() {
        ...
        JLabel lblTitle = new JLabel("Tambah Pengeluaran");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 18));
        lblTitle.setForeground(TEXT_LIGHT);
        JLabel lblSub = new JLabel("Catat pengeluaran kas atau biaya operasional");
        ...
        contentPanel.add(createLabelField("KATEGORI PENGELUARAN *"));
        cbKategori = new JComboBox<>(new String[]{"Gaji Karyawan", "Listrik & Air", "Transportasi", "Bahan Pembantu", "Pemeliharaan", "Lain-lain"});
        ...
        contentPanel.add(createLabelField("DESKRIPSI / CATATAN *"));
        txtDeskripsi = createCustomTextField("cth. Bayar listrik bulan Juni, Beli bensin...");
        contentPanel.add(txtDeskripsi);
        ...
        btnSimpan.addActionListener(e -> {
            ...
            if (jumlahStr.isEmpty() || deskripsi.isEmpty()) {
            ...
            try {
                ...
                Pengeluaran p = new Pengeluaran(0, new java.util.Date(), kategori, deskripsi, jumlah);
                
                if (pengeluaranDAO.insertPengeluaran(p)) {
                    JOptionPane.showMessageDialog(this, "Pengeluaran berhasil dicatat!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(this, "Gagal menyimpan data pengeluaran.", "Error", JOptionPane.ERROR_MESSAGE);
                }
