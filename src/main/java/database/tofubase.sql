...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jun 2026 pada 08.01
...
INSERT INTO `produk` (`id_produk`, `nama`, `satuan`, `harga_jual`, `jenis`, `stok`) VALUES
...
INSERT INTO `staff` (`id_staff`, `id_user`, `jabatan`, `tanggal_masuk`, `tanggal_keluar`) VALUES
(1, 2, 'Operator Produksi', '2024-01-15', NULL),
(2, 3, 'Operator Produksi', '2024-03-01', NULL);
